...
function GetMap(){
        ...
        Microsoft.Maps.loadModule('HtmlPushpinLayerModule', function () {
            ...
            for (var i = 0; i < loadedMarkersData.length; i++) {
                ...
                markerContent.innerHTML =
                    ...
                    ( '<div class="ts-marker__feature">"<i class="fa fa-thumbs-up"></i>",</div>')+
                    ...
                    ( ( loadedMarkersData[i]["Tipo"] !== undefined ) ? '<div class="ts-marker__image ts-black-gradient" style="background-image: url("assets/img/img-item-thumb-01.jpg")"></div>' : '<div class="ts-marker__image ts-black-gradient" style="background-image: url(assets/img/marker-default-img.png)"></div>' ) +
                    '</a></div>';
    ...
    function placeBingMarker(parameters) {
        ...
        var i = parameters["i"];
        var location = new Microsoft.Maps.Location(parseInt(loadedMarkersData[i]["X"]), parseInt(loadedMarkersData[i]["Y"]));
    ...
    function openInfobox(parameters) {
        ...
        var infobox = new Microsoft.Maps.Infobox(new Microsoft.Maps.Location(loadedMarkersData[i]["X"], loadedMarkersData[i]["Y"]), {
        ...
        infoboxHtml.innerHTML =
            '<div class="infobox-wrapper">' +
                '<div class="ts-infobox" data-ts-id="' + loadedMarkersData[i]["id"] + '">' +
                    ...
                    ( ( loadedMarkersData[i]["ribbon"] !== undefined ) ? '<div class="ts-ribbon"><i class="fa fa-thumbs-up"></i></div>' : "" ) +
        ...
        for (i = 0; i < visibleMarkersOnMap.length; i++) {
            ...
            resultsHtml.push(
                '<div class="ts-result-link" data-ts-id="' + loadedMarkersData[id]["id"] + '" data-ts-ln="' + newMarkers[id].loopNumber + '">' +
                    '<span class="ts-center-marker"><img src="assets/img/marker-active.svg"></span>' +
